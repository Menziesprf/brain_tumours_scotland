...
incidence_region_map %>% 
  ...
  labs(fill = "Crude Rate",
        x = NULL,
        y = NULL,
       title = "Incidence, region, Malignant plus glands, 1995") +
  theme(axis.text = element_blank(),
        axis.ticks = element_blank(),
        panel.background = element_blank(),
        plot.title = element_text(size = 12))
...
incidence_region_map %>% 
  ...
  labs(fill = "Crude Rate",
        x = NULL,
        y = NULL,
       title = "Incidence, region, Malignant plus glands, 1996") +
  theme(axis.text = element_blank(),
        axis.ticks = element_blank(),
        panel.background = element_blank(),
        plot.title = element_text(size = 12))
...
incidence_region_map %>% 
  ...
  labs(fill = "Crude Rate",
        x = NULL,
        y = NULL,
       title = "Incidence, region, Malignant plus glands, 1997") +
  theme(axis.text = element_blank(),
        axis.ticks = element_blank(),
        panel.background = element_blank(),
        plot.title = element_text(size = 12))
...
incidence_region_map %>% 
  ...
  labs(fill = "Crude Rate",
        x = NULL,
        y = NULL,
       title = "Incidence, region, Malignant plus glands, 1998") +
  theme(axis.text = element_blank(),
        axis.ticks = element_blank(),
        panel.background = element_blank(),
        plot.title = element_text(size = 12))
