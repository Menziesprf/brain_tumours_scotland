...
survival_clean %>% 
  ...
  coord_flip() +
  labs(title = "1 year sruvival, male")
 ...
 survival_clean %>% 
  ...
  facet_wrap(~ calendar_period_of_diagnosis, ncol = 1) +
   coord_flip() +
   labs(title = "1 year survival, female")
```
...
survival_clean %>% 
  ...
  facet_wrap(~ calendar_period_of_diagnosis, ncol = 1) +
  coord_flip() +
  labs(title = "5 year sruvival, male")
 ...
 survival_clean %>% 
  ...
  facet_wrap(~ calendar_period_of_diagnosis, ncol = 1) +
   coord_flip() +
   labs(title = "5 year survival, female")
```
...
survival_clean %>% 
  ...
  facet_wrap(~ calendar_period_of_diagnosis, ncol = 1) +
  coord_flip() +
  labs(title = "10 year sruvival, male")
 ...
 survival_clean %>% 
  ...
  facet_wrap(~ calendar_period_of_diagnosis, ncol = 1) +
   coord_flip() +
   labs(title = "10 year survival, female")
```
